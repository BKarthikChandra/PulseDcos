...
export class Init1770711809661 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "document_pages" ("document_page_id" SERIAL NOT NULL, "document_id" integer NOT NULL, "page_number" integer NOT NULL, "raw_text" text NOT NULL, "raw_hash" text, "cleanedText" text, "clean_hash" text, "created_on" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer, "updated_on" TIMESTAMP, "updated_by" integer, CONSTRAINT "UQ_fa2d8c48c0d4a9dd12298e7f627" UNIQUE ("document_id", "page_number"), CONSTRAINT "PK_af85c3653455cdb34b382b1c080" PRIMARY KEY ("document_page_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "document" ("document_id" SERIAL NOT NULL, "document_name" character varying(255) NOT NULL, "document_path" character varying(500) NOT NULL, "mimeType" character varying(50) NOT NULL, "status" character varying NOT NULL, "created_on" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer, "updated_on" TIMESTAMP, "updated_by" integer, CONSTRAINT "PK_78f5e16f1322a7b2b150364dddc" PRIMARY KEY ("document_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "document_chunks" ("id" SERIAL NOT NULL, "document_id" integer NOT NULL, "page_start" integer NOT NULL, "page_end" integer NOT NULL, "chunk_index" integer NOT NULL, "sectionPath" jsonb, "section_title" text, "chunk_text" text NOT NULL, "chunk_hash" text, "token_count" integer, "status" character varying NOT NULL DEFAULT 'PENDING', "created_on" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer, "updated_on" TIMESTAMP, "updated_by" integer, CONSTRAINT "uq_document_chunk_hash" UNIQUE ("document_id", "chunk_hash"), CONSTRAINT "PK_7f9060084e9b872dbb567193978" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_chunks_doc_chunk" ON "document_chunks" ("document_id", "chunk_index") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_de5aca7f1516342116f8be6124" ON "chunk_embeddings" ("chunk_id", "model_name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_89eb4842eec02ea7bac89890ce" ON "chunk_embeddings" ("chunk_id") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_89eb4842eec02ea7bac89890ce"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_de5aca7f1516342116f8be6124"`,
    );
